...
# External data
df_distance = pd.read_csv('data_arc.csv')
df_supply = pd.read_csv('data_plant.csv')
df_demand = pd.read_csv('data_distribution.csv')
...
df.to_csv('generated_solution.csv', index = False)
